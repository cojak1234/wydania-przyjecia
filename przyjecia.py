...
class BarcodeScannerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Przyjmowanie Listów Przewozowych")
        ...
        self.datetime_label = tk.Label(root, text=self.get_datetime(), font=("Arial", 12), bg="green", fg="white")
        self.datetime_label.pack()
        self.update_datetime()

        # Napis WYDANIE
        self.wydanie_label = tk.Label(self.root, text="PRZYJMOWANIE", font=("Arial", 30, "bold"), bg="green", fg="white")
        ...
        self.counter_label = tk.Label(root, text=f"Liczba skanowań: {self.scan_count}", font=("Arial", 12), bg="green", fg="white")
        self.counter_label.pack(pady=10)
        # Napis nad listą zeskanowanych kodów
        self.last_scans_title = tk.Label(root, text="Historia skanów:", font=("Arial", 12, "bold"), bg="green", fg="white")
    ...
    def load_scan_count(self):
        filename = os.path.join(COUNTER_PATH, f"{self.today}_przyjecia_counter.txt")
    ...
    def process_scan(self, event):
        ...
        filename = os.path.join(SAVE_PATH, f"{self.today}_przyjecia.txt")
    ...
    def on_focus_in(self, event):
        ...
        self.root.config(bg="green")
        self.datetime_label.config(bg="green")
        self.wydanie_label.config(bg="green")
        self.counter_label.config(bg="green")
        self.last_scans_title.config(bg="green")
